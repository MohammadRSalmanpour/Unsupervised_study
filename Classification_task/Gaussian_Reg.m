function [TestResult,TrainResult]=Gaussian_Reg(X,Y,No_of_folds,i,p,o)
...
gprMdl = fitrgp(Xtrn,Ytrn,'Basis','linear',...
      'FitMethod','exact','PredictMethod','exact');

 
    yhtrn = predict(gprMdl,Xtrn);
