function [TestResult,TrainResult]=Decision_TreeClassifiyer(X,Y,No_of_folds,i,p,o)
...
t=ClassificationTree.fit(Xtrn,Ytrn);
   
    yhtrn=t.predict(Xtrn);
...
%     [cm,gn] = confusionmat(Ytest,round(Yh1))
