function [TestResult,TrainResult]=KNN(X,Y,No_of_folds,i,p,o,NUMberK,SaveResults)


NUMberK=round(NUMberK);
  if NUMberK==0  || NUMberK<0
        NUMberK =2;
  end
...
mdl = fitcknn(Xtrn,Ytrn,'NumNeighbors',NUMberK);
