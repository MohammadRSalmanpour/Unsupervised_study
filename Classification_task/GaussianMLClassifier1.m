function [TestResult,TrainResult]=GaussianMLClassifier1(X,Y,No_of_folds,i,p,o)
...
g_C1 = zeros(NoC,1) ;
for Idx_train = 1:(NoTrS)     %for each data point in training sample
    %----------------------------------------------------------------------
...
%[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[Differenc to GaussianMLClassifier3]]]]]]]]]]]]]]]]]]] 
   ...
   %-----------------------------------------------------------------------
   Yh_Train(Idx_train) = find(g_C1 == max(g_C1)); % if gi(x)>gj(x) (for all j ~=i) classify this data as class i
end
...
%[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[Differenc to GaussianMLClassifier3]]]]]]]]]]]]]]]]]]] 
   ...
   %-----------------------------------------------------------------------
   Yh_Test(Idx_test) = find(g_C1 == max(g_C1)); % if gi(x)>gj(x) (for all j ~=i) classify this data as class i
end
